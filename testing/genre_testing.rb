...
music_data = {
       ...
       "head bangers":{
                       ...
                       "Megadeth": [
                        ...
                        "Motley Crue": [
                          "Shout at the Devil", "Symphony of Destruction", "Hangar 18", "Angry Again", "Sweating Bullets", "Peace Sells"
                        ],
...
#method_1 : 
            ...
            arr_genres = music_data.select do |genre, artist|
                 puts genre.capitalize
                end
